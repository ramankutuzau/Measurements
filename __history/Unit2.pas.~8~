  ...
  with MySQLQueryClient do begin
    ...
    while not eof do begin
      ...
      with LabelDate do begin
        ...
        Width := 107;
        Height := 15;
        Caption := 'Дата: '+fieldByname('ListMeasurementsDate').AsString+' |';
      ...
      with LabelUser do begin
        ...
        Width := 170;
        Height := 15;
        Caption := ' Исполнитель: '+fieldByname('UserName').AsString;
        Font.Charset := RUSSIAN_CHARSET;
        Font.Color := clWindowText;
        Font.Height := -13;
        Font.Name := 'SF UI Display';
      ...
      with LabelStatus do begin
        ...
        Width := 149;
        Height := 15;
        Caption := 'Статус: '+fieldByname('MeasurementsStatus').AsString;
        Font.Charset := RUSSIAN_CHARSET;
        Font.Color := clWindowText;
        Font.Height := -13;
        Font.Name := 'SF UI Display';
