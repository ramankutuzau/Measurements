          ...
          if length(EditFlat.Text) <= 5 then begin
           if length(EditEntrance.Text) <= 5 then begin
            if length(EditFloor.Text) <= 5 then begin
             ...
             end else ShowMessage('Комментарий не может быть больше 255 символов');
            end else ShowMessage('Этаж не может быть больше 5 символов');
           end else ShowMessage('Номер подъезда не может быть больше 5 символов');
          end else ShowMessage('Номер квартиры не может быть больше 5 символов');
         end else ShowMessage('Номер дома не может быть больше 5 символов');
        end else ShowMessage('Название улицы не может быть больше 100 символов');


       end else ShowMessage('Город не может быть больше 100 символов');



      end else ShowMessage('Введите номер дома');
     end else ShowMessage('Введите название улицы');
    end else ShowMessage('Выберите исполнителя');
